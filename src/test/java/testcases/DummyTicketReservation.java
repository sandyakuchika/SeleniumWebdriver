...
public class DummyTicketReservation extends BaseTest{
...
//			
//			WebElement we = driver.findElement(By.xpath("//select[@aria-label='Select year']"));
//			Select year= new Select(we);
//			year.selectByVisibleText("1983");
//			
//			we = driver.findElement(By.xpath("//select[@aria-label='Select month']"));
//			Select month= new Select(we);
